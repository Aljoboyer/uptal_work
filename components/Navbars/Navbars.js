    ...
    <div style={{width: '100%',}}>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav >
                ...
                <Nav.Link  className="mt-2 "> <Link href={'/apply-for-job'}><a ><span className="right-nav-span">Apply As Developer</span></a></Link></Nav.Link>
                <Nav.Link className="mx-2" >
                        <button href='/hire-developers' className="getstarted_btn">Hire Remote Developers</button>
                </Nav.Link>
