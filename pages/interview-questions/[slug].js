      ...
      renderNode: {
         ...
         [BLOCKS.HEADING_4]: (node, next) =>{
            ...
            return(
                <>
                <p>{next}</p>
                <Button onClick={()=>{setVisible1(!visible1)}}>View Answer</Button>
                </>
            )
         },
    ...
    renderNode: {
       ...
       [BLOCKS.HEADING_4]: (node, next) =>{
          ...
          return(
              <>
              <p>{next}</p>
              <Button onClick={()=>{setVisible2(!visible2)}}>View Answer</Button>
              </>
          )
       }
        ...
        renderNode: {
           ...
           [BLOCKS.HEADING_4]: (node, next) =>{
              ...
              return(
                  <>
                  <p>{next}</p>
                  <Button onClick={()=>{setVisible3(!visible3)}}>View Answer</Button>
                  </>
              )
           },
           [BLOCKS.UL_LIST]: (node, next) =>{
...
renderNode: {
    ...
    [BLOCKS.HEADING_4]: (node, next) =>{
        ...
        return(
            <>
            <p>{next}</p>
            <Button onClick={()=>{setVisible4(!visible4)}}>View Answer</Button>
            </>
        )
    },
    [BLOCKS.UL_LIST]: (node, next) =>{
    ...
    renderNode: {
       ...
       [BLOCKS.HEADING_4]: (node, next) =>{
          ...
          return(
              <>
              <p>{next}</p>
              <Button onClick={()=>{setVisible5(!visible5)}}>View Answer</Button>
              </>
          )
       },
       [BLOCKS.UL_LIST]: (node, next) =>{
        ...
        renderNode: {
           ...
           [BLOCKS.HEADING_4]: (node, next) =>{
              ...
              return(
                  <>
                  <p>{next}</p>
                  <Button onClick={()=>{setVisible6(!visible6)}}>View Answer</Button>
                  </>
              )
           },
           [BLOCKS.UL_LIST]: (node, next) =>{
            ...
            renderNode: {
               ...
               [BLOCKS.HEADING_4]: (node, next) =>{
                  ...
                  return(
                      <>
                      <p>{next}</p>
                      <Button onClick={()=>{setVisible7(!visible7)}}>View Answer</Button>
                      </>
                  )
               },
               [BLOCKS.UL_LIST]: (node, next) =>{
    ...
    renderNode: {
        ...
        [BLOCKS.HEADING_4]: (node, next) =>{
            ...
            return(
                <>
                <p>{next}</p>
                <Button onClick={()=>{setVisible8(!visible8)}}>View Answer</Button>
                </>
            )
        },
        [BLOCKS.UL_LIST]: (node, next) =>{
        ...
        renderNode: {
           ...
           [BLOCKS.HEADING_4]: (node, next) =>{
              ...
              return(
                  <>
                  <p>{next}</p>
                  <Button onClick={()=>{setVisible9(!visible9)}}>View Answer</Button>
                  </>
              )
           },
           [BLOCKS.UL_LIST]: (node, next) =>{
            ...
            renderNode: {
               ...
               [BLOCKS.HEADING_4]: (node, next) =>{
                  ...
                  return(
                      <>
                      <p>{next}</p>
                      <Button onClick={()=>{setVisible10(!visible10)}}>View Answer</Button>
                      </>
                  )
               },
               [BLOCKS.UL_LIST]: (node, next) =>{
    ...
    return (
      <div>
        <Row className="mx-auto">
            ...
            <div>
            <p>{contentIntro}</p>
            <p>{documentToReactComponents(question1,option1)}</p>
            <p>{documentToReactComponents(question2,option2)}</p>
            <p>{documentToReactComponents(question3,option3)}</p>
            <p>{documentToReactComponents(question4,option4)}</p>
            <p>{documentToReactComponents(question5,option5)}</p>
            <p>{documentToReactComponents(question6,option6)}</p>
            <p>{documentToReactComponents(question7,option7)}</p>
            <p>{documentToReactComponents(question8,option8)}</p>
            <p>{documentToReactComponents(question9,option9)}</p>
            <p>{documentToReactComponents(question10,option10)}</p> 
            </div>
