            ...
            <Row className='container-fluid hire_details_banner mx-auto'>
                ...
                <Col className='align-items-center' lg={7} md={6} sm={6} xs={12}>
                  ...
                  <div className='d-flex blog_details_container'>
                    <p className='hire_banner_text'>Welcome to Turing jobs where you’ll find the best remote software roles. Apply now, and work with top U.S. companies from the comfort of your home. Get long-term, full-time job opportunities and be a part of the elite 1% of the world's remote engineers.</p>
                  </div>
                  <div className='mt-3'>
