  ...
  return (
    <div className="" style={{width:"100%"}}>
        <Row className="container-fluid mx-auto">
            ...
            <Row className="container-fluid  justify-content-around  brand_section mx-auto gy-3">
           ...
           <div className="expect_section_div">
            <Row className="container-fluid expect_section mx-auto">
                  <div>
                  ...
                  <Row className="expect_point">
                      <Col className="ps-0"  lg={4} md={4} sm={12}>
            ...
            <div className="faq_div">
              <Row className="container-fluid mx-auto faq_section justify-content-evenly">
                <Col lg={6} md={5} sm={6}>
            ...
            <div className="join_div">
              <Row className='container-fluid justify-content-center mx-auto join_full_container-fluid '>
            <Col lg={11} md={12} sm={12} xs={10} className=''>
                  <Row className="join_work_container-fluid justify-content-md-between">
